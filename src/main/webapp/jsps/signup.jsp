...
<body>
    <div class="form">
        <form class="register-form" method="post" name="signUpForm">
            ...
            <input class="field" type="text" name="clientName" required placeholder="<fmt:message key="signup.clientName" />"/>
            <input class="field" type="text" name="clientSurname" required placeholder="<fmt:message key="signup.clientSurname"/>"/>
            <input class="field" type="text" name="clientPhone" required placeholder="<fmt:message key="signup.clientPhone"/>"/>
            <input class="field" type="email" required name="clientEmail" placeholder="<fmt:message key="signup.clientEmail"/>"/>
            <input class="field" type="password" name="clientPass" required placeholder="<fmt:message key="login.pass"/>"/>
